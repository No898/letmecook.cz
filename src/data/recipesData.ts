...
export interface Recipe {
    id: string; // Přidáno ID pro jednoznačnou identifikaci
    title: string;
...
// Pole receptů (zatím jen jeden)
export const recipes: Recipe[] = [
    {
        id: "vietnamese-meatballs",
        title: "Autentické vietnamské masové kuličky (Thịt viên) – domácí recept z Hanoje",
        vietnameseTitle: "Thịt viên",
        imageUrl: "/images/vietnamese-meatballs.webp",
        description: "Vietnamské smažené masové kuličky thịt viên připravené k podávání. Tradičně neobsahují strouhanku ani vejce – soudržnost zajišťuje škrob a dobře promíchané maso.",
        ingredients: [
            {
        ...
        procedure: [
            ...
            },
            {
                ...
                briefSteps: [
                    "Vytvarujte pevné kuličky (cca 3-4 cm)."
                ]
            },
            {
    ...
    // Sem můžeš přidávat další objekty s recepty
]; 