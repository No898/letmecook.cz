  ...
  ingredients: [
    {
      ...
      items: [
        "500 g thịt heo xay (lý tưởng là có ~30% mỡ, ví dụ: thịt vai hoặc ba chỉ)",
        "2 củ hành tím (hoặc 1 củ hành tây nhỏ; băm nhuyễn)",
        "3 tép tỏi (băm nhuyễn)",
        "1 đến 2 muỗng canh nước mắm (tùy khẩu vị)",
        "1/2 muỗng cà phê tiêu đen xay",
        "1 muỗng cà phê đường (hoặc một ít hạt nêm / bột ngọt)",
        "2 muỗng cà phê (10 đến 15 g) bột bắp hoặc bột năng",
  ...
  procedure: [
    {
      ...
      steps: [
        ...
        "Nêm nước mắm, đường (hoặc hạt nêm), và tiêu xay. Cuối cùng cho bột vào.",
        ...
        "Để hỗn hợp nghỉ trong tủ lạnh khoảng 10 đến 15 phút để thịt ngấm gia vị.",
      ],
      briefSteps: [
    ...
    },
    {
      ...
      steps: [
        "Dùng tay đã làm ẩm hoặc thoa chút dầu ăn, nặn hỗn hợp thịt đã nghỉ thành những viên nhỏ có đường kính khoảng 3 đến 4 cm (cỡ quả bóng bàn).",
        "Khi nặn thịt, không nên dùng lòng bàn tay ấn quá mạnh để thịt viên không bị dai, nhưng cũng cần nặn chặt tay để thịt không bị vỡ khi chiên.",
        "Đặt các viên thịt đã nặn xong lên đĩa. (Với lượng nguyên liệu này, bạn sẽ được khoảng 15 đến 20 viên).",
      ],
    ...
    },
    {
      ...
      steps: [
        "Trong chảo lớn hoặc wok, đun nóng một lớp dầu (khoảng 1 đến 2 cm) ở lửa vừa.",
        "Chiên thịt viên từ từ các mặt cho đến khi vàng đều. Đừng để lửa quá lớn kẻo thịt bị cháy bên ngoài mà bên trong còn sống.",
        "Lật các viên thịt để chín đều; tổng thời gian khoảng 5 đến 7 phút.",
